...
public class GameGoalView_1 : UIBase {
    ...
    public override void Display()
    {
        ...
        {
            hidePos = UIManager.Instance().GetUIDefaultPos(2) + new Vector3(bgImage1.rectTransform.sizeDelta.x / 2, -bgImage1.rectTransform.sizeDelta.y / 2, 0);
            hidePos = hidePos / 100;
        ...
        {
            hidePos = UIManager.Instance().GetUIDefaultPos(2) + new Vector3(bgImage2.rectTransform.sizeDelta.x / 2, -bgImage2.rectTransform.sizeDelta.y, 0);
            hidePos = hidePos / 100;
            showPos = hidePos + new Vector3(-offset, 0, 0);
